...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "dumb_fnc_recompile") then {dumb_recompiles = []; dumb_fnc_recompile = {{call _x} forEach dumb_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; dumb_recompiles pushBack _recomp;
#else
